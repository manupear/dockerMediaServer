...
if docker compose version &> /dev/null ; then DockerBin="docker compose --env-file /smb/backups/docker-server-env/.env" ;
elif docker-compose -v &> /dev/null; then DockerBin="docker-compose --env-file /smb/backups/docker-server-env/.env" ;
